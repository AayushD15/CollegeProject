...
const UIColor = () => (
    <MainCard title="Events">
        <Grid container spacing={gridSpacing}>
            <Grid item xs={12}>
                <SubCard title="Zestech">
                    <Grid container spacing={gridSpacing}>
                        <Grid item xs={12} sm={6} md={4} lg={2}>
                            <ColorBox bgcolor="primary.main" data={{ color: '50' }} title="Event 1" />
                        </Grid>
                        <Grid item xs={12} sm={6} md={4} lg={2}>
                            <ColorBox bgcolor="primary.dark" data={{ color: '50' }} title="Event 2" />
                        </Grid>
                        <Grid item xs={12} sm={6} md={4} lg={2}>
                            <ColorBox bgcolor="primary.800" data={{ color: '50' }} title="Event 3" />
                        </Grid>
                    </Grid>
                </SubCard>
            </Grid>
            ...
            <Grid item xs={12}>
                <SubCard title="Aahvan">
                    <Grid container spacing={gridSpacing}>
                        <Grid item xs={12} sm={6} md={4} lg={2}>
                            <ColorBox bgcolor="success.light" data={{ color: '50' }} title="Event 1" dark />
                        </Grid>
                        <Grid item xs={12} sm={6} md={4} lg={2}>
                            <ColorBox bgcolor="success.main" data={{ color: '50' }} title="Event 2" />
                        </Grid>
                        <Grid item xs={12} sm={6} md={4} lg={2}>
                            <ColorBox bgcolor="success.main" data={{ color: '50' }} title="Event 3" />
                        </Grid>
                    </Grid>
                </SubCard>
                ``
